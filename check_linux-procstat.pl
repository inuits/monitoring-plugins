...
# ============================== SUMMARY =====================================
#
# Program : check_linux-procstat.pl
# Version : 0.4
# Date    : January 9, 2012
...
#   ./check_linux-procstat.pl -help
#
# Usage: ./check_linux-procstat.pl [-v] [[-P <filename> | -] | [-O oid -H <host> (-C <snmp_community>) [-2] | (-l login -x passwd [-X pass -L <authp>,<privp>) [-p <port>]]] [-w <warn cpu%> -c <crit cpu%>] [-f] [-t <timeout>] [-V] [-N <number of real cpus> [-n <number of cpu cores>]] 
# 
...
#        command_line $USER1$/check_linux-procstat.pl -f -w $ARG1$ -c $ARG2$
# }
#
# define service{
#       use                             prod-service
...
#        command_line $USER1$/check_linux-procstat.pl -O 1.3.6.1.4.1.2021.201 -H $HOSTADDRESS$ -L sha,aes -l $_HOSTSNMP_V3_USER$ -x $_HOSTSNMP_V3_AUTH$ -X $_HOSTSNMP_V3_PRIV$ -f -w $ARG1$ -c $ARG2$
# }
#
...
# define command {
#        command_name check_snmp_linuxcpustat
#        command_line $USER1$/check_by_snmp -O 1.3.6.1.4.1.2021.201 -H $HOSTADDRESS$ -L sha,aes -l $_HOSTSNMP_V3_USER$ -x $_HOSTSNMP_V3_AUTH$ -X $_HOSTSNMP_V3_PRIV$ --exec $USER1$/check_linux-procstat.pl -f -w $ARG1$ -c $ARG2$ -P -
# }
#
...
# ./check_linux-procstat.pl -f -N 2 -n 4
